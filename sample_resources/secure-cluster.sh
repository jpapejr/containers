...
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-all-workers-private.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-egress-pods-private.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-ibm-ports-private.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-icmp-private.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-private-service-endpoint.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-sys-mgmt-private.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-private-services.yaml -c "$CALICO_CONFIG"
calicoctl apply -f calico-policies/private-network-isolation/calico-v3/$SECURE_REGION/allow-private-services-pods.yaml -c "$CALICO_CONFIG"
